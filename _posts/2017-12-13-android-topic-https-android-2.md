...
在上一篇博客中《[Android HTTPS之自签名证书认证（一）](www.onroad.tech/android-topic-https-android-1/)单向认证》，我们主要介绍了https单向认证，单向认证安全级基本上可以满足大部分应用场景，但仍有部分应用场景需要更高的安全级别，如涉及资金安全等场景，接下来在这一篇博客中，我们将在上一篇博客的基础上介绍一下如何进行双向认证，双向认证安全级别更高。
